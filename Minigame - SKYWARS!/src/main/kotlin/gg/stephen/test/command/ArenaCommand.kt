    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        when {
            ...
            args.size == 2 && args[0].equals("join", true) -> {
                ...
                if (arena.state == GameState.LOADING) {
                    sender.sendMessage(Component.text("You can't join the game just yet."))
                    return false
                }

                if (arena.players.size >= ConfigManager.MAX_PLAYERS) {
                    sender.sendMessage(Component.text("This arena is full!"))
                    return false
                }
