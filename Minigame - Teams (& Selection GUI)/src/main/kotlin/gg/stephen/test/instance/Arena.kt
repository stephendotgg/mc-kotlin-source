...
import gg.stephen.test.team.Team
...
class Arena(val id: Int, private val spawn: Location) {
    ...
    val teams = mutableMapOf<Player, Team>()
    ...
    fun addPlayer(player: Player) {
        ...
        (Team.entries.minByOrNull { team -> teams.values.count { it == team } } ?: Team.entries.random()).let { team ->
            teams[player] = team
            player.sendMessage(Component.text("You were automatically placed on ").append(team.display))
        }
